...
const paramsSchema = {
 ...
 reassignArray: z
   ...
   .describe("Array of exactly 6 unique numbers [1, 2, 3, 4, 5, 6] representing ability reassignment order: [strength, dexterity, constitution, intelligence, wisdom, charisma]"),
};
